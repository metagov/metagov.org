...
<div x-data="{ modal: false }" @toggle_modal.window="modal = !modal" x-init="$watch('modal', value => handleModalToggle(value))">
  <div role="dialog" aria-labelledby="modal_label" aria-modal="true" tabindex="0" x-cloak x-show="modal" x-trap.noscroll.inert="modal" @click="modal = false" @keydown.escape="modal = false" class="fixed top-0 left-0 w-full h-screen flex justify-center items-end lg:items-center z-[9999]">
