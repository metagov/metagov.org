<template x-teleport="body">
  <div role="dialog" aria-labelledby="modal_label" aria-modal="true" tabindex="0" x-cloak x-show="openPerson" x-trap.noscroll.inert="openPerson" @click="openPerson = false" @click.away="openPerson = false" @keydown.window.escape="openPerson = false" class="fixed top-0 left-0 w-full h-screen flex justify-center items-end lg:items-center z-[9999]">
    <div aria-hidden="true" class="absolute top-0 left-0 w-full h-screen bg-default/40 transition duration-300" x-cloak x-show="openPerson" x-transition.opacity x-transition:leave="delay-150"></div>
